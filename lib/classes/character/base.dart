...
enum CastePrivilege {
  ...
  familier(caste: Caste.artisan, title: 'Familier', cost: 1),
  notable(caste: Caste.artisan, title: 'Notable', cost: 3),
  ...
  faveurPolitiqueArtisan(caste: Caste.artisan, title: 'Faveur politique', cost: 4),
  tuteurArtisan(caste: Caste.artisan, title: 'Tuteur', cost: 8),
  ...
  botteSecrete(caste: Caste.combattant, title: 'Botte secrète', cost: 5),
  ...
  vigilance(caste: Caste.combattant, title: 'Vigilance', cost: 4),
  alliesMercenairesCombattant(caste: Caste.combattant, title: 'Alliés mercenaires', cost: 6),
  compagnonsDeBatailleCombattant(caste: Caste.combattant, title: 'Compagnons de bataille', cost: 6),
  ...
  faveurPolitique(caste: Caste.commercant, title: 'Faveur politique', cost: 2),
  fournisseurDePoisons(caste: Caste.commercant, title: 'Fournisseur de poisons', cost: 5),
  notorieteCommercant(caste: Caste.commercant, title: 'Notoriété', cost: 2),
  ...
  messagerCommercant(caste: Caste.commercant, title: 'Messager', cost: 4),
  relationsDAffairesCommercant(caste: Caste.commercant, title: "Relations d'affaires", cost: 6),
  ambassade(caste: Caste.erudit, title: 'Ambassade', cost: 3),
  aplomb(caste: Caste.erudit, title: 'Aplomb', cost: 1),
  avalDraconique(caste: Caste.erudit, title: 'Aval draconique', cost: 6),
  ...
  faveurPolitiqueErudit(caste: Caste.erudit, title: 'Faveur politique', cost: 4),
  messagerErudit(caste: Caste.erudit, title: 'Messager', cost: 4),
  ...
  messager(caste: Caste.mage, title: 'Messager', cost: 2),
  prevoyance(caste: Caste.mage, title: 'Prévoyance', cost: 2),
  sortilegeFetiche(caste: Caste.mage, title: 'Sortilège fétiche', cost: 4),
  style(caste: Caste.mage, title: 'Style', cost: 3),
  tuteur(caste: Caste.mage, title: 'Tuteur', cost: 4),
  ...
  influences(caste: Caste.protecteur, title: 'Influences', cost: 3),
  ...
  notorieteProtecteur(caste: Caste.protecteur, title: 'Notoriété', cost: 8),
  archer(caste: Caste.voyageur, title: 'Archer', cost: 6),
  compagnons(caste: Caste.voyageur, title: 'Compagnong', cost: 3),
  ...
  const CastePrivilege({ required this.caste, required this.title, required this.cost });
}
