...
enum CastePrivilege {
  ...
  compagnonDuVoyage(
      caste: Caste.artisanNoir,
      title: 'Compagnon du voyage',
  ...
  faussaire(
      caste: Caste.artisanNoir,
      title: 'Faussaire',
      description: "L’artisan noir est très doué pour copier d’autres œuvres. Il gagne um bonus de 3 sur tous ses jets de Contrefaçon d’œuvres d’art ou d’artisanat (et pas sur la copie d’écriture, de signature, de documents, etc.).",
      cost: [3]
  ),
  mecene(
      caste: Caste.artisanNoir,
      title: 'Mécène',
      description: "L’artisan a un mécène qui lui achète ses meilleures réalisations si la qualité est au rendez-vous. Suivant le coût d’achat du Privilège, la Difficulté du jet d’Artisanat diminue. Pour 3 points, la Difficulté est de 25, pour 4 elle est de 20, pour 5 elle est de 15. La base de rémunération est de 500 dracs de fer + 500 par Nivean de Réussite. L’artisan doit travailler pendant un minimum de trois semaines pour apporter une œuvre présentable à son mécène.",
      cost: [3,4,5]
  ),
  ...
  graphologue(
      caste: Caste.eruditNoir,
      title: 'Graphologue',
      description: "L’érudit a appris à discerner les schémas de pensée sous l’écriture. Du moment que l’érudit dispose d’au moins vingt lignes manuscrites, il peut faire un jet de Mental + Psychologie ou Lire et écrire (prendre 1e plus faible des deux) Difficulté 15. Il obtient une information + une par Niveau de Réussite sur la psychologie de l’auteur.",
      cost: [3]
  ),
  reseauOcculte(
      caste: Caste.eruditNoir,
  ...
  emotionsExacerbees(
      caste: Caste.mageNoir,
      title: 'Émotions exacerbées',
      description: "Le mage retient à grand peine ses émotions, mais il a appris à s’en servir lors du lancement de ses sorts. Sur un jet de Mental + Empathie Difficulté 5, le mage gagne un bonus de 1 par Niveau de Réussite pour un lancement de sort. Ce privilège demande de se plonger dans une émotion compatible avec le sort lancé. Si une des Clés du sort est une émotion, obtenir 2NR sur ce Privilège octroie de plus le bonus de Clé parfaite. Le meneur de jeu peut demander un bon roleplay pour accorder la totalité du bonus obtenu. À cause du drain d’énergie que cela représente, le mage ne récupère cette capacité qu’après avoir dormi ou médité.",
      cost: [5]
  ),
  espritEsclave(
      caste: Caste.mageNoir,
      title: 'Esprit esclave',
  ...
  compagnonDeShar(
      caste: Caste.voyageurFataliste,
      title: 'Compagnon de Shar',
