...
import '../../ui/session/command_dispatcher.dart';
import 'map_model.dart';
import 'map_model_item.dart';
import 'map_model_movable_item.dart';
...
class MapEntityModel extends MapModelMovableItem {
  ...
  double get attackMovementDistance => 0.0;//entity.attackMovementDistance * map.background.pixelsPerMeter;
  ...
  EntityHealthStatusValue get status => entity.healthStatus.value;
  set status(EntityHealthStatusValue st) {
    entity.healthStatus.value = st;
    notifyListeners();
  }
...
class _MapEntityWidgetState extends State<MapEntityWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if(model.entity.healthStatus.value & EntityHealthStatusValue.dead != EntityHealthStatusValue.none) {
      movable = false;
      borderColor = Colors.black;
    }
    else if(model.entity.healthStatus.value & EntityHealthStatusValue.unconscious != EntityHealthStatusValue.none) {
      movable = false;
