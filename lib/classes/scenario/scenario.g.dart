...
Scenario _$ScenarioFromJson(Map<String, dynamic> json) => Scenario(
  ...
  encounters: (json['encounters'] as List<dynamic>?)
      ...
      .toList(),
  events: _$JsonConverterFromJson<Map<String, dynamic>, ScenarioDays>(
    json['events'],
    const ScenarioDaysJsonConverter().fromJson,
  ),
...
Map<String, dynamic> _$ScenarioToJson(Scenario instance) => <String, dynamic>{
  ...
  'events': const ScenarioDaysJsonConverter().toJson(instance.events),
};
