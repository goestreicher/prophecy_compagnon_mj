...
class CharacterInjuryManagerWidget extends StatefulWidget {
  const CharacterInjuryManagerWidget({
    super.key,
  ...
  @override
  State<CharacterInjuryManagerWidget> createState() => _CharacterInjuryManagerWidgetState();
}

class _CharacterInjuryManagerWidgetState extends State<CharacterInjuryManagerWidget> {
  @override
