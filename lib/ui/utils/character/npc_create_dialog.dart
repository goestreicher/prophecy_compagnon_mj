...
class NPCCreateDialog extends StatefulWidget {
  ...
  @override
  State<NPCCreateDialog> createState() => _NPCCreateDialogState();
}

class _NPCCreateDialogState extends State<NPCCreateDialog> {
            ...
            children: [
              ...
              DropdownMenuFormField(
                ...
                filterCallback: (List<DropdownMenuEntry<NPCCategory>> entries, String filter) {
                  ...
                  var ret = entries
                    .where(
                      (DropdownMenuEntry<NPCCategory> c) => c.label.toLowerCase().contains(lcFilter)
                    ).toList();
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        if(widget.cloneFrom == null) {
                          ...
                          npc = widget.cloneFrom!.clone(nameController.text);
