...
class NPCCreateForm extends StatefulWidget {
  const NPCCreateForm({
    super.key,
  ...
  @override
  State<NPCCreateForm> createState() => _NPCCreateFormState();
}

class _NPCCreateFormState extends State<NPCCreateForm> {
        ...
        children: [
          ...
          DropdownMenuFormField(
            ...
            onSelected: (NPCSubCategory? s) async {
              ...
              setState(() {
                subCategory = sub;
                subCategoryController.text = sub?.title ?? '';
              });
            },
