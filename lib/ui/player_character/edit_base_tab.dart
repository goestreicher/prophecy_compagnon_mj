              ...
              Column(
                ...
                children: [
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () {
                              ...
                              if(_dragonController.text.isEmpty) return;
                              int? input = int.tryParse(_dragonController.text);
                              if(input == null) return;
                              if(input > 0) {
                                --input;
                                _dragonController.text = input.toString();
                                setState(() {
                                  widget.character.tendencies.dragon.value = input!;
                                });
                              }
                            },
                          ),
                  ...
                  _TendencyCirclesInputWidget(
                    count: widget.character.tendencies.dragon.circles,
                    onChanged: (int count) {
                      setState(() {
                        widget.character.tendencies.dragon.circles = count;
                      });
                    },
                    onTendencyIncreased: () {
                      if(widget.character.tendencies.dragon.value < 5) {
                        setState(() {
                          widget.character.tendencies.dragon.value += 1;
                          _dragonController.text = widget.character.tendencies.dragon.value.toString();
                          widget.character.tendencies.dragon.circles = 0;
                        });
                      }
                    },
                    onTendencyDecreased: () {
                      if(widget.character.tendencies.dragon.value > 0) {
                        setState(() {
                          widget.character.tendencies.dragon.value -= 1;
                          _dragonController.text = widget.character.tendencies.dragon.value.toString();
                          widget.character.tendencies.dragon.circles = 10;
                        });
                      }
                    },
                  ),
        ...
        Positioned(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Row(
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          FocusScope.of(context).unfocus();
                          if(_fatalityController.text.isEmpty) return;
                          int? input = int.tryParse(_fatalityController.text);
                          if(input == null) return;
                          if(input > 0) {
                            --input;
                            _fatalityController.text = input.toString();
                            setState(() {
                              widget.character.tendencies.fatality.value = input!;
                            });
                          }
                        },
                      ),
                  ...
                  SizedBox(
                    width: 28.0,
                    child: TextFormField(
                      controller: _fatalityController,
                      decoration: const InputDecoration(
                        border: OutlineInputBorder(),
                        isCollapsed: true,
                        contentPadding: EdgeInsets.symmetric(horizontal: 0.0, vertical: 8.0),
              ...
              const SizedBox(height: 4.0),
              _TendencyCirclesInputWidget(
                count: widget.character.tendencies.fatality.circles,
                onChanged: (int count) {
                  setState(() {
                    widget.character.tendencies.fatality.circles = count;
                  });
                },
                onTendencyIncreased: () {
                  if(widget.character.tendencies.fatality.value < 5) {
                    setState(() {
                      widget.character.tendencies.fatality.value += 1;
                      _fatalityController.text = widget.character.tendencies.fatality.value.toString();
                      widget.character.tendencies.fatality.circles = 0;
                    });
                  }
                },
                onTendencyDecreased: () {
                  if(widget.character.tendencies.fatality.value > 0) {
                    setState(() {
                      widget.character.tendencies.fatality.value -= 1;
                      _fatalityController.text = widget.character.tendencies.fatality.value.toString();
                      widget.character.tendencies.fatality.circles = 10;
                    });
                  }
                },
              ),
        ...
        Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        FocusScope.of(context).unfocus();
                        if(_humanController.text.isEmpty) return;
                        int? input = int.tryParse(_humanController.text);
                        if(input == null) return;
                        if(input > 0) {
                          --input;
                          _humanController.text = input.toString();
                          setState(() {
                            widget.character.tendencies.human.value = input!;
                          });
                        }
                      },
                    ),
                ...
                const SizedBox(height: 4.0),
                _TendencyCirclesInputWidget(
                    count: widget.character.tendencies.human.circles,
                    onChanged: (int count) {
                      setState(() {
                        widget.character.tendencies.human.circles = count;
                      });
                    },
                  onTendencyIncreased: () {
                    if(widget.character.tendencies.human.value < 5) {
                      setState(() {
                        widget.character.tendencies.human.value += 1;
                        _humanController.text = widget.character.tendencies.human.value.toString();
                        widget.character.tendencies.human.circles = 0;
                      });
                    }
                  },
                  onTendencyDecreased: () {
                    if(widget.character.tendencies.human.value > 0) {
                      setState(() {
                        widget.character.tendencies.human.value -= 1;
                        _humanController.text = widget.character.tendencies.human.value.toString();
                        widget.character.tendencies.human.circles = 10;
                      });
                    }
                  },
                ),
