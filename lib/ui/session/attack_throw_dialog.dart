...
class AttackThrowDialog extends StatefulWidget {
  ...
  @override
  State<AttackThrowDialog> createState() => _AttackThrowDialogState();
}

class _AttackThrowDialogState extends State<AttackThrowDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: const Text("Résolution d'attaque - Jet d'attaque"),
      content: Column(
