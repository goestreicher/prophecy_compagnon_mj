...
import 'package:prophecy_compagnon_shared/ui/equipment/equipment_requirements_edit_widget.dart';
import 'package:prophecy_compagnon_shared/ui/equipment/scarcity_edit_widget.dart';
import 'package:prophecy_compagnon_shared/ui/equipment/special_capabilities_edit_widget.dart';
...
class _ArmorEditDialogState extends State<ArmorEditDialog> {
  ...
  void initState() {
    ...
    if(widget.armor != null) {
      ...
      intrinsicResistance = widget.armor!.intrinsicResistance;
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            ...
            if(widget.armor == null) {
              ...
              widget.armor!.intrinsicResistance = intrinsicResistance;
