...
enum Caste {
  ...
  static final Map<Caste, Map<CasteStatus, List<String>>> _benefits = {
    Caste.artisan: {
    ...
    Caste.mage: {
      CasteStatus.apprenti: [
        "Le personnage peut lire les matrices magiques et déchiffrer les bracelets de mage pour en reconnaître les domaines d’influence grâce à leurs couleurs, leurs matières, leurs gravures, etc. Il peut développer une Spécialisation de Combat ou de Théorie.",
        "Passion élémentaire : ce bénéfice n'est disponible qu'après le Conseil Éthernien de 1312 AdE. Pour chaque Sphère qu'il maîtrise, le personnage peut, une fois par jour, faire apparaître une pulsion chez l'un de ses interlocuteurs. Il peut s'agir de fureur (Feu), d'autorité (Pierre), d'altruisme (Cités)… La cible peut tenter de résister en réussissant un jet de Social + Volonté contre une Difficulté de 25."
      ],
      CasteStatus.initie: [
        "En réussissant un jet de Mental + Intelligence contre une Difficulté de 15, le personnage peut reconnaître un sort lancé par un autre mage. Si le sort utilise sa Sphère privilégiée, la Difficulté de ce jet est réduite de 5.",
        "Œil chimérique : ce bénéfice n'est disponible qu'après le Conseil Éthernien de 1312 AdE. Ce Bénéfice permet au personnage d'identifier des lanceurs innés. En réussissant un jet de Mental + Empathie contre une Difficulté de (15 + points de magie de la Sphère innée), le mage reconnaît son interlocuteur comme possesseur de magie naturelle ou de magie intuitive. De même, il peut aussi identifier la Sphère qui est maîtrisée."
      ],
      CasteStatus.expert: [
        "Le personnage est désormais autorisé à concevoir ses propres sorts, à les enseigner et à créer des matrices magiques pour répandre son savoir. Ce bénéfice évite ainsi que de trop jeunes mages ne s'essayent à la dangereuse conception d'un sort.",
        "Main du mentor : ce bénéfice n'est disponible qu'après le Conseil Éthernien de 1312 AdE. Ce Bénéfice permet de transférer une partie des points de magie du mage à un être possédant des points de magie (que ce soit une réserve personnelle ou des points de Sphère). Il est possible de donner autant de points de magie que le mage le désire. Les points de Sphère peuvent aller dans la Réserve personnelle ou dans la Sphère concernée, et les points de Réserve ne peuvent être transférés qu'en Réserve."
      ],
