...
import 'package:prophecy_compagnon_shared/ui/character/relations/caste_privilege_picker_dialog.dart';
import 'package:prophecy_compagnon_shared/ui/entity/base/skill_picker_dialog.dart';
            ...
            onPressed: () async {
              var p = await showDialog<CharacterCastePrivilege>(
                ...
                builder: (BuildContext context) =>
                  CastePrivilegePickerDialog(
                    defaultCaste: widget.caste,
                    limitToDefaultCaste: true,
                    currentPrivileges: current,
                    maxCost: (model.remainingXP / 3).floor(),
                  ),
              );
              if(p == null) return;
